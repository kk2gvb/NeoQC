...
<p align="center">
  <img
    src="docs/assets/neoqc-report-preview.webp"
    alt="Автономный HTML-отчёт NeoQC: сводка статусов, матрица R1/R2 и графики качества"
    width="920"
  >
</p>
...
- уровни дупликации визуализируются при наличии совместимого TSV, но пока не
  рассчитываются нативно из FASTQ;
...
Подробности интеграции: [контракт графиков](docs/plots.md),
