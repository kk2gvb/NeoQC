...
на другом компьютере без установки NeoQC и без доступа к интернету. После графика
дупликации отчёт также показывает таблицу overrepresented sequences отдельно для
R1 и R2.
