...
if(NOT TOTAL_READS EQUAL 10)
    message(FATAL_ERROR "Expected 10 reads in rounded distribution, got ${TOTAL_READS}")
endif()

if(NOT TOTAL_READS_TRUNCATE EQUAL 10)
    message(FATAL_ERROR "Expected 10 reads in truncated distribution, got ${TOTAL_READS_TRUNCATE}")
endif()