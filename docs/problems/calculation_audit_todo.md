...
Исправлено: Зафисированно кодировка Phred+33, было принято решение оставить только его, были добавлены тесты на кодировку
...
Исправлено: было добвлено распределение по соседним bins, FastQC-legasy график, также был оставлен старый вариант, но отмечанным с помощью крестиков для того чтобы не нагружать график 
